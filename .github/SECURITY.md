...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/systemet/security/advisories/new)
...
- This repository (`hyperpolymath/systemet`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/systemet/security/advisories)
...
When using systemet, we recommend:
...
*Thank you for helping keep systemet and its users safe.* 🛡️
