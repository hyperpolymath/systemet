...
;;
;; Guix package definition for systemet
;;
;; Usage:
;;   guix shell -D -f guix.scm    # Enter development shell
;;   guix build -f guix.scm       # Build package
;;
;; TODO: Replace systemet and customize inputs for your language/stack.
...
(package
  ...
  (home-page "https://github.com/hyperpolymath/systemet")
  (synopsis "The Equality Theory specification and proof obligations that the anytype kernel implements.")
