...
Proposed — **DRAFT, awaiting owner ruling. Decides nothing until accepted.**

This ADR was drafted by an agent to convert an open-ended block into a
decision. It is deliberately written as *alternatives with a recommendation*,
not as a fait accompli. Nothing here may be cited as theory until the Status
line reads `Accepted`.
...
**Recommended: Alternative B (parametric L0 observation).** Presented against
the two realistic competitors.

### Alternative A — Adopt a concrete L0 semantics
...
### Alternative B — Parametric L0 observation *(recommended)*
...
### Alternative C — Syntactic image identity
...
Adopt **B**, with **C** retained as a lemma-level strengthening. Concretely:
