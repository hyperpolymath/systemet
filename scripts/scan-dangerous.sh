...
PATTERNS='believe_me|assert_total|postulate|sorry|Admitted|unsafeCoerce|Obj\.magic|\badmit\b|\baxiom\b|\bAxiom\b|native_decide'
dangerous=0
...
strip_comments() {
  ...
  case "$ext" in
    idr|agda)      lc='--'; bo='{-'; bc='-}' ;;   # line + block comments
    lean)          lc='--'; bo='/-'; bc='-/' ;;   # Lean block comments differ
